...
/**
 * Restock-group layout. Guards behind auth + a selected branch (RECEIPT
 * movements are posted to the branch's warehouse).
 */
export default function RestockLayout() {
  ...
  return (
    ...
    >
      <Stack.Screen name="batch" options={{ title: 'Receive stock' }} />
    </Stack>
  );
}
