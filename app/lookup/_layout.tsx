...
/**
 * Lookup-group layout. Guards behind auth + a selected branch (the lookup
 * reads stock at the branch's warehouse).
 */
export default function LookupLayout() {
  ...
  return (
    ...
    >
      <Stack.Screen name="scan" options={{ title: 'Product lookup' }} />
    </Stack>
  );
}
